...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    @media(max-width: 960px) { .main { grid-template-columns: 1fr; } .footer-top { grid-template-columns: 1fr 1fr; } }
    @media(max-width: 640px) { .hero-stats { gap: 24px; } .nav-links a:not(.register-btn):not(.user-profile-nav) { display: none; } .footer-top { grid-template-columns: 1fr; } }
  </style>
</head>
<body>
  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <div class="hero-stats">
        <div class="hero-stat"><strong>500+</strong><span>Articles</span></div>
        <div class="hero-stat"><strong>50K+</strong><span>Readers</span></div>
        <div class="hero-stat"><strong>Daily</strong><span>Updates</span></div>
      </div>
    </div>
  </section>
    ...
    <aside class="sidebar">
      ...
      <div class="sidebar-widget">
        ...
        <div class="newsletter" id="newsletterBox">
          ...
          <button type="button" class="newsletter-btn" onclick="subscribeNewsletter()">Subscribe Now &#8594;</button>
        </div>
      </div>
  ...
  <footer>
    <div class="footer-top">
      ...
      <div class="footer-col">
        <h4>Categories</h4>
        <a href="index.php?page=home&category=Technology">Technology</a>
        <a href="index.php?page=home&category=Entertainment">Entertainment</a>
        <a href="index.php?page=home&category=Business">Business</a>
        <a href="index.php?page=home&category=Finance">Finance</a>
      </div>
      <div class="footer-col">
        <h4>Company</h4>
        <a href="index.php?page=about">About Us</a>
        <a href="index.php?page=about">Contact</a>
        <a href="index.php?page=about">Careers</a>
      </div>
      <div class="footer-col">
        <h4>Legal</h4>
        <a href="index.php?page=about">Privacy Policy</a>
        <a href="index.php?page=about">Terms of Use</a>
      </div>
    </div>
  ...
  <script>
    // Simple front-end newsletter acknowledgement (no backend mailing list in this project)
    function subscribeNewsletter() {
      var box = document.getElementById('newsletterBox');
      var email = document.getElementById('newsletterEmail');
      if (!email || email.value.trim() === '') {
        if (email) { email.focus(); email.style.borderColor = '#ef4444'; }
        return;
      }
      box.innerHTML = '<p style="color:#10b981; font-weight:600; margin:0;">&#10004; Thanks for subscribing! The latest news will arrive in your inbox.</p>';
    }
  </script>
