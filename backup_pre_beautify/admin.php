...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav>
      ...
      <a href="index.php?page=post"><span class="icon">📝</span> Posts</a>
      <a href="index.php?page=list"><span class="icon">👥</span> Users</a>
      <a href="index.php?page=detail"><span class="icon">👤</span> Profile</a>
    </nav>
